...
namespace Osmium {
    ...
    namespace Input {
        ...
        */
        ...
        class XMLBZ2 : public Base<THandler> {
        ...
        public:
            ...
            */
            XMLBZ2(Osmium::OSMFile& file, THandler& handler) : Base<THandler>(file, handler), m_current_object(NULL), m_in_delete_section(false) {
            }
